...
given time budget. This limitation is particularly evident in complex
models, such as the Pacemaker case study, where the tight coupling of
timing constraints increases the search space, causing the solver to
time out before a valid candidate is found.
