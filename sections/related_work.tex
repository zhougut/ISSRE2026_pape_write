...
TARTAR \cite{kolbl2019clock}. Clock-bound repair encodes timed diagnostic traces into
linear real arithmetic and uses MaxSMT solving to compute small
modifications to guard and invariant bounds \cite{kolbl2019clock}. TARTAR extends this
...
diagnostic traces, and full-property regression verification in NTA
...
style of reasoning to NTA semantics, where candidate
validity must consider both timing properties and preservation of the
