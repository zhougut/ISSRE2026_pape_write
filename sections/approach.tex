...
guaranteed through full-property regression verification and an
admissibility check.
...
insufficient. MPTA-Repair then extracts the newly observed TDTs and
appends them to the pool, guiding the subsequent refinement
round.
