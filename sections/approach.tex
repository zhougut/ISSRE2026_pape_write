...
extends it to the multi-property setting \cite{koelbl2019clock}. Given
...
To block this violating behavior while preserving executability of the
discrete path skeleton, the single-trace repair obligation eliminates
the vector of trace-specific delay and valuation variables
$\mathbf{z}_{\tau}$ via the quantifier elimination operator
$\operatorname{QE}$:
\begin{equation}
  \Psi_{\tau,\varphi}(\theta)
  =
